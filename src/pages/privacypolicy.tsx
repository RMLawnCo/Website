    ...
    return (
        <>
            <div className="paragraph marginCenter">
                <h1 className="center">Privacy Policy for rmlawnco.com</h1>
                <p>At rmlawnco.com, accessible from https://rmlawnco.com/, one of our main priorities is
                    the privacy of our visitors. This Privacy Policy document contains types of
                    information that is collected and recorded by rmlawnco.com and how we use it.</p>
                <p>If you have additional questions or require more information about our Privacy Policy,
                    do not hesitate to contact us.</p>

                <h2>Log Files</h2>
                <p>rmlawnco.com follows a standard procedure of using log files. These files log
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript,
                    ...
                    appear on rmlawnco.com, which are sent directly to users' browser. They automatically
                ...
                <p>Note that rmlawnco.com has no access to or control over these cookies that are
                    used by third-party advertisers.</p>

                <h2>Third Party Privacy Policies</h2>
                <p>rmlawnco.com's Privacy Policy does not apply to other advertisers or websites.
                ...
                <h2 className="center">Children's Information</h2>
                ...
                <p>rmlawnco.com does not knowingly collect any Personal Identifiable Information
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for
                    ...
                    collect in rmlawnco.com. This policy is not applicable to any information
                    collected offline or via channels other than this website.</p>

                <h2 className="center">Consent</h2>
